...
public class DisplayFilteredIncome2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DisplayFilteredIncome2 frame = new DisplayFilteredIncome2();
	...
	public DisplayFilteredIncome2() {
		...
		JLabel lblIncomeManager = new JLabel("Filtered Incomes");
		...
		button = new JButton("");
		button.setIcon(new ImageIcon(DisplayFilteredIncome2.class.getResource("/View/images/left-arrow.png")));
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(DisplayFilteredIncome2.class.getResource("/View/images/user.png")));

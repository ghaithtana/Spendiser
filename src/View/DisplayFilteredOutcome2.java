...
public class DisplayFilteredOutcome2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DisplayFilteredOutcome2 frame = new DisplayFilteredOutcome2();
	 ...
	 * Create the frame.
	 */
	public DisplayFilteredOutcome2() {
		...
		JLabel lblIncomeManager = new JLabel("Filtered Outcomes");
		...
		button = new JButton("");
		button.setIcon(new ImageIcon(DisplayFilteredOutcome2.class.getResource("/View/images/left-arrow.png")));
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(DisplayFilteredOutcome2.class.getResource("/View/images/user.png")));
